...
|03|[Boceto de Modelo Canvas con Archify](/Practica03/README.md)|El estudiantes realizara un prompt para solicitar el modelo bussiness canvas para una herramienta multiplataforma que exista o use en su vida cotidianda.|10|Completada ✅ |
### Autor
